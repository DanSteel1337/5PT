...
export function PoolQualification() {
  ...
  // Updated pool qualification data with three decimal places and correct USD values
  // based on initial token price of $0.00175
  const pools = [
    {
      id: 1,
      name: "Pool 1",
      personalInvestment: "550.000 5PT (~$962.50)",
      directPartners: 1,
      directInvestment: "550.000 5PT (~$962.50)",
      poolShare: "0.0175%",
      isExclusive: false,
    },
    {
      id: 2,
      name: "Pool 2",
      personalInvestment: "1,450.000 5PT (~$2,537.50)",
      directPartners: 3,
      directInvestment: "1,450.000 5PT (~$2,537.50)",
      poolShare: "0.0175%",
      isExclusive: false,
    },
    {
      id: 3,
      name: "Pool 3",
      personalInvestment: "3,000.000 5PT (~$5,250)",
      directPartners: 5,
      directInvestment: "6,000.000 5PT (~$10,500)",
      poolShare: "0.0175%",
      isExclusive: false,
    },
    {
      id: 4,
      name: "Pool 4",
      personalInvestment: "5,500.000 5PT (~$9,625)",
      directPartners: 10,
      directInvestment: "11,000.000 5PT (~$19,250)",
      poolShare: "0.0175%",
      isExclusive: false,
    },
    {
      id: 5,
      name: "Pool 5",
      personalInvestment: "14,250.000 5PT (~$24,937.50)",
      directPartners: 15,
      directInvestment: "28,500.000 5PT (~$49,875)",
      poolShare: "0.0175%",
      isExclusive: false,
    },
    {
      id: 6,
      name: "Pool 6",
      personalInvestment: "28,500.000 5PT (~$49,875)",
      directPartners: 20,
      directInvestment: "85,500.000 5PT (~$149,625)",
      poolShare: "0.01%",
      isExclusive: false,
    },
    {
      id: 7,
      name: "Pool 7",
      personalInvestment: "57,000.000 5PT (~$99,750)",
      directPartners: 20,
      directInvestment: "171,000.000 5PT (~$299,250)",
      poolShare: "0.01%",
      isExclusive: false,
    },
    {
