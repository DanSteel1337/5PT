...
const TokenomicsChart = dynamic(() => import("./tokenomics-chart").then((mod) => mod.TokenomicsChart), {
  ssr: false,
      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2">
          <Card>
            ...
            <CardContent>
              <div className="h-[300px]">{mounted && <TokenomicsChart data={tokenomicsData} colors={COLORS} />}</div>
            </CardContent>
          </Card>
          <Card>
            <CardHeader>
